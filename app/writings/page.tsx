  ...
  return (
    <div className="mt-10 mb-5">
      ...
      <div className="hidden sm:block">
        <div className="border-gray-6 border-b">
              ...
              <a
                ...
                className={cx(
                  tab.current
                    ...
                    : 'text-gray-9 hover:border-gray-8 hover:text-gray-11 border-transparent',
  ...
  <div className="py-24 sm:py-32">
    <div className="mx-auto max-w-7xl px-6 lg:px-8">
      <div className="mx-auto max-w-2xl">
        <h2 className="text-gray-12 text-3xl font-bold tracking-tight sm:text-4xl">From the blog</h2>
        <p className="text-gray-11 mt-2 text-lg leading-8">Learn how to grow your business with our expert advice.</p>
        <Tabs />
        <div className="space-y-16 pt-10 sm:mt-16 sm:pt-16">
          {posts.map(post => (
            <article key={post.id} className="flex max-w-xl flex-col items-start justify-between">
              <div className="flex items-center gap-x-4 text-xs">
                <time dateTime={post.datetime} className="text-gray-11">
                  {post.date}
                </time>
                <a
                  href={post.category.href}
                  className="text-gray-10 bg-gray-3 hover:bg-gray-4 relative z-10 rounded-full py-1.5 px-3 font-medium"
                >
                  {post.category.title}
                </a>
              </div>
              <div className="group relative">
                <h3 className="text-gray-12 group-hover:text-text-gray-11 mt-3 text-lg font-semibold leading-6">
                  <a href={post.href}>
                    <span className="absolute inset-0" />
                    {post.title}
                  </a>
                </h3>
                <p className="text-gray-11 mt-5 line-clamp-3 text-sm leading-6">{post.description}</p>
              </div>
              ...
              {/*      </a>*/}
              {/*    </p>*/}
              {/*    <p className="text-text-gray-11">{post.author.role}</p>*/}
              {/*  </div>*/}
              {/*</div>*/}
            </article>
          ))}
