...
const LoremIpsum = ({}: LoremIpsumProps) => {
  return (
    <div
      className="bg-neutral-1 dark:bg-neutralDark-1 relative flex min-h-screen flex-col justify-center
      overflow-hidden py-8 lg:py-12"
    >
      <div
        className="absolute inset-0 bg-[url(/static/grid.svg)] bg-top
          [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))]"
      ></div>
      <div
        className="ring-neutral-6/50 dark:ring-neutralDark-6/75 shadow-neutral-10/10  dark:shadow-neutralDark-3/5
          dark:bg-neutralDark-2 relative w-full bg-white px-6 py-12 shadow-xl ring-1
          md:mx-auto md:max-w-3xl lg:max-w-4xl lg:pt-16 lg:pb-28"
      >
        <div className="mx-auto max-w-prose lg:text-lg">
          <svg className="h-6" fill="none" viewBox="0 0 297 24">
            ...
            ></path>
            <path
              className="fill-neutral-12 dark:fill-neutralDark-12"
        ...
        <div className="prose prose-sm prose-h1:font-display  prose-h3:font-display  prose-h3:font-display dark:prose-invert lg:prose mx-auto mt-8">
          <p className="lead">
